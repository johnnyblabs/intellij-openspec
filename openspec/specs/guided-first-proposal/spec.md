# Guided First Proposal

## Purpose
Contextual guidance for first-time proposal creation, including placeholder text, workflow explanation, and post-proposal next-steps notification.
