...
echo ""
echo "  1. Open http://forgejo.geek/user/settings/applications"
...
FORGEJO_URL="${FORGEJO_URL:-http://forgejo.geek}"
read -r "input_url?  Forgejo base URL [${FORGEJO_URL}]: "
...
echo ""
echo "  1. Open http://plane.geek/openspec/settings/api-tokens/"
...
PLANE_URL="${PLANE_URL:-http://plane.geek}"
read -r "input_plane_url?  Plane base URL [${PLANE_URL}]: "
